...
def del_Cookies(x,u):
#This Function doesn't currently work. Receives error. This sqlite3. db has an error due to chrome.
	...
	con = None
	try:
		con = sqlite3.connect('C:\Users\%s\AppData\Local\Google\Chrome\User Data\Default\Cookies' % (u))
...
def del_NAP(x,u):
	...
	try:
		...
		con = sqlite3.connect(p)
		#con = sqlite3.connect('Network Action Predictor')
		cur = con.cursor()
